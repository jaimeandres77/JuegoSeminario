...
public class UIManager : MonoBehaviour {
    ...
    void UpdateResUI(ResolutionScreenType type, int score)
    {
        ...
        switch (type)
        {
            ...
            case ResolutionScreenType.Finish:
                ...
                uIElements.ResolutionStateInfoText.text = "PUNTAJE FINAL";

                StartCoroutine(CalculateScore());
                uIElements.FinishUIElements.gameObject.SetActive(true);
                uIElements.HighScoreText.gameObject.SetActive(true);
                uIElements.HighScoreText.text = ((highscore > events.StartupHighscore) ? "<color=yellow>new </color>" : string.Empty) + "PuntuaciónMaxima: " + highscore;
                break;
        }
    }
    ...
    void UpdateScoreUI()
    {
        uIElements.ScoreText.text = "Puntuación: " + events.CurrentFinalScore;
    }
}